...
<figure>
  <img src="{% src 'IMG_4929_xuamay.jpg' %}"
    srcset="{% srcset 'IMG_4929_xuamay.jpg' %}"
    sizes="(min-width: 980px) 928px, calc(95.15vw + 15px)"
    alt="Highway exit sign for Happy, TX"
    loading="lazy"
    width="2190" height="1573">
  <figcaption>Happy, Texas - if only happiness were always so easy to find</figcaption>
</figure>

## Palo Duro Canyon

<figure>
  <img src="{% src 'IMG_4937_thv4i5.jpg' %}"
    srcset="{% srcset 'IMG_4937_thv4i5.jpg' %}"
    sizes="(min-width: 980px) 928px, calc(95.15vw + 15px)"
    alt="Palo Duro canyon panorama view"
    loading="lazy"
    width="3202" height="2382">
  <figcaption>I arrived right at sunset.  She greeted me with a gorgeous canyon panorama in the changing light... as well as a swarm of those amorous biting flies.</figcaption>
</figure>
...
<figure>
  <img src="{% src 'IMG_5037_eggoe3.jpg' %}"
    srcset="{% srcset 'IMG_5037_eggoe3.jpg' %}"
    sizes="(min-width: 980px) 928px, calc(95.15vw + 15px)"
    alt=""
    loading="lazy"
    width="3264" height="2448">
  <figcaption>Turkey loitering around my tent</figcaption>
</figure>
...
<figure>
  <img src="{% src 'IMG_4994_ljwv7l.jpg' %}"
    srcset="{% srcset 'IMG_4994_ljwv7l.jpg' %}"
    sizes="(min-width: 980px) 928px, calc(95.15vw + 15px)"
    alt=""
    loading="lazy"
    width="3264" height="2448">
  <figcaption>"Driftwood" on the lighthouse trail with canyon rims in background</figcaption>
</figure>
