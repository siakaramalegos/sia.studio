...
<figure>
  <img src="{% src 'IMG_5046_epuzz7.jpg' %}"
    srcset="{% srcset 'IMG_5046_epuzz7.jpg' %}"
    sizes="(min-width: 980px) 928px, calc(95.15vw + 15px)"
    alt=""
    loading="lazy"
    width="2448" height="2725">
  <figcaption>Semi-Curious Elk</figcaption>
</figure>
...
<figure>
  <img src="{% src 'IMG_5082_mgiugp.jpg' %}"
    srcset="{% srcset 'IMG_5082_mgiugp.jpg' %}"
    sizes="(min-width: 980px) 928px, calc(95.15vw + 15px)"
    alt=""
    loading="lazy"
    width="3264" height="2448">
  <figcaption>Alpine Tundra</figcaption>
</figure>
...
<figure>
  <img src="{% src 'IMG_5118_copy_wiflox.jpg' %}"
    srcset="{% srcset 'IMG_5118_copy_wiflox.jpg' %}"
    sizes="(min-width: 980px) 928px, calc(95.15vw + 15px)"
    alt="Chipmunks checking me out from a boulder in front of Bear Lake"
    loading="lazy"
    width="3098" height="1551">
  <figcaption>Fun with Chipmunks</figcaption>
</figure>

<figure>
  <img src="{% src 'rocky_mtn_pano_copy_zcgbpg.jpg' %}"
    srcset="{% srcset 'rocky_mtn_pano_copy_zcgbpg.jpg' %}"
    sizes="(min-width: 980px) 928px, calc(95.15vw + 15px)"
    alt=""
    loading="lazy"
    width="8740" height="2244">
  <figcaption>Rocky Mountain National Park panorama</figcaption>
</figure>
